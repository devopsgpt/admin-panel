...
const AWSCloudFormation: FC = () => {
  ...
  const getServicesMethod = useForm<AWSCloudformationSchema>({
    resolver: zodResolver(awsCloudFormationSchema),
  });
  ...
  async function handleSubmitService(body: AWSCloudformationSchema) {
    try {
